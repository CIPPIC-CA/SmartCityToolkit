...
|---|
| **Issues.**|  
|:warning: Registration data will often contain personal information |
|:warning: Privacy issues may also arise with respect to the application developed, as such applications often collect user data for both analytic and personalization purposes.|
| **Managing Issues**.  |
...
|---|
| **Issues.**|  
|:warning: Legal authorship of apps will lie with their authors, as these authors are not employees of the municipality. |
|:warning: As such, allocating liability resulting from use of the app in question could be contentious.|
|:warning: Data partnerships between public entities and private companies raise complex issues of who owns the data that results from them. |
| **Managing Issues**|   
|:heavy_check_mark: Contractual licensing or assigning of copyright of the hackathon-produced app and resulting data to the municipality if the municipality is not the sole producer or analyzer of the data.|   
|:heavy_check_mark: Licensing of the technology if it is patentable.|   
|:heavy_check_mark: Licensing if use of a trademarked technology is necessary.|   
|:heavy_check_mark: Warranties and representations of ownership and/or non-infringement to avoid future disagreements.|   
|:heavy_check_mark: Contractually allocating liability arising from app use to either the municipality, the author or the user.|   
|:heavy_check_mark: See also: [intellectual property issues](https://cippic-ca.github.io/SmartCityToolkit/intellectual-property.html).|   
